...
Once the `conda-forge` channel has been enabled, `pyeit` can be installed with:

```
conda install pyeit
```

It is possible to list all of the versions of `pyeit` available on your platform with:
